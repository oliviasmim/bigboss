import { PageContainer, Card, H4, Paragraph, ContainerFlex, TitleHeader } from "./styles"
    ...
    return (
        <PageContainer>
            <TitleHeader>
                ...
                <p>Cadastre clientes atuais e futuros. Organize seus produtos e projetos.  
                   Relatórios completos e atualizados para um melhor controle. </p>
            </TitleHeader>
            <ContainerFlex>
                <Card>
                    <img src={Image1} alt="pie chart" />
                    <H4>Cadastre potenciais clientes</H4>
                    <Paragraph>Com apenas alguns cliques, tenha uma visão geral dos cadastros</Paragraph>
                </Card>
                <Card>
                ...
                <Card>
                    ...
                    <Paragraph>Tenha fácil acesso a planilhas do excel com o relatório do seu negócio.</Paragraph>
                </Card>
            </ContainerFlex>
        </PageContainer>
    )
